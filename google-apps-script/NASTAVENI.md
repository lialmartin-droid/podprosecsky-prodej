# Nastavení Google Apps Scriptu V19.1
...
4. Kód ulož.
5. Funkci `setup` spusť pouze tehdy, pokud ještě nebyla spuštěna. Existující objednávky, produkty ani heslo nemaže.
...
Pouhé uložení `Code.gs` nestačí. Oprava měsíční tržby se projeví až po vytvoření nové verze implementace.
